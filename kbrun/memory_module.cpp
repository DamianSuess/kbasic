...
memory_module::~memory_module		()
{
  ...
  QMap<int, module_*>::Iterator it2;
  for ( it2 = list_module.begin(); it2 != list_module.end(); ++it2 ) {
    module_ *m = *it2;
...
int 		memory_module::addModule			(const char *acName, pcode *myPcode, int pc_pos, const char *acFile, int nId/*, int nExtend*/)
{
    ...
    if (nId == -1) nId = nIdCounter; else nIdCounter = nId;    
		...
		module_ *c = newModule(acName, myPcode, pc_pos, acFile);
    
    c->bIsCached = bIsCached;

		list_module.insert(nIdCounter, c);
		list_module2.insert(acName, c);
...
/*
int memory_module::getParentId(int nId)
{
	module_ *m = findModule	(nId);
	if (m != 0){
			return m->nExtend;
...
int			memory_module::getParentId					(const char *acName)
{

	if (list_module2.contains(acName)){
		return list_module2[acName]->nExtend;
	}
...
int			memory_module::getId					(const char *acName)
{
	...
	if (list_module2.contains(acName)){
		return list_module2[acName]->nId;
	}
...
bool		memory_module::addParameterSub(int nModuleId, int nId, const char *acName, const char *acType, int nParameterCall, bool bOptional, bool bDefault, bool bParamArray, t_array *a, defaultvalue *defval, int *nParamId)
{
	module_ *m = findModule	(nModuleId);
	if (m != 0){
...
bool		memory_module::firstParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId)
{
	module_ *m = findModule	(nModuleId);
	if (m != 0){
...
bool		memory_module::nextParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId)
{
	module_ *m = findModule	(nModuleId);
	if (m != 0){
...
bool		memory_module::lastParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId)
{
	module_ *m = findModule	(nModuleId);
	if (m != 0){
...
bool		memory_module::prevParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId)
{
	module_ *m = findModule	(nModuleId);
	if (m != 0){
...
bool		memory_module::getParameterSub	(int nModuleId, int nId, const char *acName_, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId)
{	
	module_ *m = findModule	(nModuleId);
	if (m != 0){
...
{
  idx = _idx;
  it[idx] = list_module.begin();
	module_ *c = (*it[idx]);
	return it[idx] != list_module.end();
}
