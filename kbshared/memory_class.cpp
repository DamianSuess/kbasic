...
memory_class::~memory_class		()
{
  ...
  if (list_class.first(&key, &value)){
    do {

      class_ *m = (class_ *) value;
    ...
    } while (list_class.next(&key, &value));
  }
                                     ...
                                     )
{
    ...
    bool bIsCached = nId != 0;
    
    if (bIsCached){      
      if (nIdCounter < nId) nIdCounter = nId;
    } else {
		  nIdCounter++;
    }
    ...
    list_class.add(nId, (int) c);
		list_class2.addString(acName, (int) c);
...
int			memory_class::getParentId					(const char *acName)
{
	if (list_class2.contains(acName)){
		return ((class_ *) (list_class2.getString(acName)))->nExtend;
	}
...
{
	if (list_class2.contains(acName)){
		return ((class_ *) (list_class2.getString(acName)))->nId;
	}
...
bool		memory_class::addParameterMethod(int nClassId, int nId, const char *acName, const char *acType, int nParameterCall, bool bOptional, bool bDefault, bool bParamArray, t_array *a, defaultvalue *defval, int *nParamId, int *nParamLStringLen)
{
...
bool		memory_class::firstParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::nextParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::lastParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::prevParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::getParameterMethod	(int nClassId, int nId, const char *acName_, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{	
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::addParameterPropertySet(int nClassId, int nId, const char *acName, const char *acType, int nParameterCall, bool bOptional, bool bDefault, bool bParamArray, t_array *a, defaultvalue *defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertySet->addParameter(nId, acName, acType, nParameterCall, bOptional, bDefault, bParamArray, a, defval, nParamId, nParamLStringLen);

	}
	return false;
}

bool		memory_class::firstParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertySet->firstParameter(nId, acName, acType, nParameterCall, bOptional, bDefault, bParamArray, a, defval, nParamId, nParamLStringLen);

	}
	return false;
}

bool		memory_class::nextParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertySet->nextParameter(nId, acName, acType, nParameterCall, bOptional, bDefault, bParamArray, a, defval, nParamId, nParamLStringLen);

	}
	return false;
}

bool		memory_class::lastParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertySet->lastParameter(nId, acName, acType, nParameterCall, bOptional, bDefault, bParamArray, a, defval, nParamId, nParamLStringLen);

	}
	return false;
}

bool		memory_class::prevParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertySet->prevParameter(nId, acName, acType, nParameterCall, bOptional, bDefault, bParamArray, a, defval, nParamId, nParamLStringLen);

	}
	return false;
}

bool		memory_class::getParameterPropertySet	(int nClassId, int nId, const char *acName_, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen)
{	
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertySet->getParameter(nId, acName_, acType, nParameterCall, bOptional, bDefault, bParamArray, a, defval, nParamId, nParamLStringLen);
...
{
  //if (list_class.size() == 0) return false;

  idx = _idx;
  return list_class.first(&key, (int *) &it[idx]);
}
...
{
  idx = _idx;
  return list_class.next(&key, (int *) &it[idx]);
}
...
int memory_class::getLStringLenVar	(int nClassId, int nId)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
int memory_class::getLStringLenVar	(const char *acClass_, const char *acName)
{
	class_ *m = findClass	(getId(acClass_));
	if (m != 0){
...
int		memory_class::addStaticVar	(int nClassId, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId)
{
    ...
    //int nLStringLen = 0;
		...
		return m->static_vars->declare(m->acName, acSub, acName, nType, a, bByVal, bReference, bStatic, nScope, nLStringLen, nId);
...
int		memory_class::typeStaticVar	(const char *acClass_, const char *acName)
{
	...
	if (m != 0){
		...
		return nId;//m->static_vars->type(nId);
...
int memory_class::getLStringLenStaticVar	(int nClassId, int nId)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->static_vars->getLStringLen(nId);

	}
	return false;
}

int memory_class::getLStringLenStaticVar	(const char *acClass_, const char *acName)
{
	class_ *m = findClass	(getId(acClass_));
	if (m != 0){
    ...
    return m->static_vars->getLStringLen( m->static_vars->getId(m->acName, acSub, acName) );
...
int		memory_class::addStaticCodeVar	(int nClassId, const char *acName, int nType, t_array *a, bool bStatic, int nLStringLen, int nScope)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
    ...
    //int nLStringLen = 0;
		...
		return m->staticCode_vars->declare(m->acName, acSub, acName, nType, a, bByVal, bReference, bStatic, nScope, nLStringLen);
...
int memory_class::getLStringLenStaticCodeVar	(int nClassId, int nId)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->staticCode_vars->getLStringLen(nId);

	}
	return false;
}

int memory_class::getLStringLenStaticCodeVar	(const char *acClass_, const char *acName)
{
	class_ *m = findClass	(getId(acClass_));
	if (m != 0){
    ...
    return m->staticCode_vars->getLStringLen( m->staticCode_vars->getId(m->acName, acSub, acName) );
...
int memory_class::getLStringLenMethodVar	(int nClassId, const char *acMethod, int nVar)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

    return m->mySub->getLStringLenVar(m->acName, acMethod, nVar);

	}
	return false;
}

int memory_class::getLStringLenMethodVar	(const char *acClass_, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(getId(acClass_));
	if (m != 0){

    return m->mySub->getLStringLenVar( m->acName, acMethod, acName );
...
int memory_class::getLStringLenPropertyGetVar	(int nClassId, const char *acProperty, int nVar)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

    return m->myPropertyGet->getLStringLenVar(m->acName, acProperty, nVar);

	}
	return false;
}

int memory_class::getLStringLenPropertyGetVar	(const char *acClass_, const char *acProperty, const char *acName)
{
	class_ *m = findClass	(getId(acClass_));
	if (m != 0){

    return m->myPropertyGet->getLStringLenVar( m->acName, acProperty, acName );
...
int memory_class::getLStringLenPropertySetVar	(int nClassId, const char *acProperty, int nVar)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

    return m->myPropertySet->getLStringLenVar( m->acName, acProperty, nVar );

	}
	return false;
}

int memory_class::getLStringLenPropertySetVar	(const char *acClass_, const char *acProperty, const char *acName)
{
	class_ *m = findClass	(getId(acClass_));
	if (m != 0){

		return m->myPropertySet->getLStringLenVar(m->acName, acProperty, acName);
...
int		memory_class::addMethodConst(int nClassId, const char *acMethod, const char *acName, int nId)
{
    ...
    int nScope = token__PUBLIC;
		...
		return m->mySub->addConst(nClassId, acMethod, acName, nScope, nId);
...
int		memory_class::addPropertyGetConst(int nClassId, const char *acMethod, const char *acName, int nId)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
    ...
    int nScope = token__PUBLIC;
		...
		return m->myPropertyGet->addConst(nClassId, acMethod, acName, nScope, nId);

	}
	return 0;
}

bool		memory_class::firstPropertyGetConst	(int nClassId, const char *acMethod, const char **acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::nextPropertyGetConst	(int nClassId, const char *acMethod, const char **acName)
{
  class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::getPropertyGetConst	(int nClassId, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		int nId = m->myPropertyGet->getIdConst(m->acName, acMethod, acName);
...
bool		memory_class::existPropertyGetConst	(int nClassId, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertyGet->existConst(m->acName, acMethod, acName);

	}
	return false;
}

bool		memory_class::existPropertyGetConst	(const char *acModuleName, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(getId(acModuleName));
	if (m != 0){
...
int		memory_class::getIdPropertyGetConst				(int nClassId, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

    do {
      int n =  m->myPropertyGet->getIdConst(m->acName, acMethod, acName);
      if (n > 0) return n;
...
int		memory_class::getIdPropertyGetConst				(const char *acModuleName, const char *acMethod, const char *acName)
{
  return getIdPropertyGetConst(getId(acModuleName), acMethod, acName);
}

memory_const		*memory_class::getPropertyGetConsts	(int nClassId, const char *acMethod)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){

		return m->myPropertyGet->getConsts(m->acName, acMethod, acMethod);

	}
	return 0;
}

memory_const		*memory_class::getPropertyGetConsts	(const char *acModuleName, const char *acMethod)
{
	return getPropertyGetConsts(getId(acModuleName), acMethod);
}

// ******

int		memory_class::addPropertySetConst(int nClassId, const char *acMethod, const char *acName, int nId)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::firstPropertySetConst	(int nClassId, const char *acMethod, const char **acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::nextPropertySetConst	(int nClassId, const char *acMethod, const char **acName)
{
  class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::getPropertySetConst	(int nClassId, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::existPropertySetConst	(int nClassId, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
bool		memory_class::existPropertySetConst	(const char *acModuleName, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(getId(acModuleName));
	if (m != 0){
...
int		memory_class::getIdPropertySetConst				(int nClassId, const char *acMethod, const char *acName)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
int		memory_class::getIdPropertySetConst				(const char *acModuleName, const char *acMethod, const char *acName)
{
  return getIdPropertySetConst(getId(acModuleName), acMethod, acName);
}

memory_const		*memory_class::getPropertySetConsts	(int nClassId, const char *acMethod)
{
	class_ *m = findClass	(nClassId);
	if (m != 0){
...
memory_const		*memory_class::getPropertySetConsts	(const char *acModuleName, const char *acMethod)
{
	return getPropertySetConsts(getId(acModuleName), acMethod);
}
