...
public:
	...
	int 		addModule			 (const char *acName, pcode *myPcode, int pc_pos, const char *acFile, int nId = 0/*, int nExtend*/);
  ...
  bool		isCachedSub(int nModuleId, int nId);
	...
	bool addParameterSub(int nModuleId, int nId, const char *acName, const char *acType, int nParameterCall, bool bOptional, bool bDefault, bool bParamArray, t_array *a, defaultvalue *defval, int *nParamId, int *nParamLStringLen);
	bool firstParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool nextParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool lastParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool prevParameterSub	(int nModuleId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool getParameterSub	(int nModuleId, int nId, const char *acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
  ...
  int addVar(int nModuleId, const char *acName, int nType, t_array *a, int nScope, int nLStringLen, int nId = 0);
  bool removeVar(int nModuleId, int nId);
	...
	bool existVar (int nModuleId, int nId);
	...
	int   getLStringLenVar		(int nModuleId, int nId);
	int  getLStringLenVar		(const char *acModuleName, const char *acName);
	memory_variable *getVars	(int nModuleId);
	memory_variable *getVars	(const char *acModuleName);


	int addSubVar(int nModuleId, const char *acSub, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId = 0);
  bool removeSubVar(int nModuleId, int nSubId, int nId);
	...
	int  getLStringLenSubVar		(int nModuleId, const char *acSub, int nVar);
	int  getLStringLenSubVar		(const char *acModuleName, const char *acSub, const char *acName);
	...
	int addConst(int nModuleId, const char *acName, int nScope, int nId = 0);
	...
	int addSubConst(int nModuleId, const char *acSub, const char *acName, int nId = 0);
...
private:
  ...
  XIntMap list_module;
  XIntMap list_module2;
  module_ *it[parser__MAX_ITERATOR];
