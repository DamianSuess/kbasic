...
const int MAX_SKALAR_GLOBALVAR_ID	= 40000000;  // border: begin of global variables declared in default.kbasic


const double scanner__KBASIC_VERSION = 1.080924; // versionsnr.xx jahr xx monat xx tag
const double interpreter__KBASIC_VERSION = 1.080924; // versionsnr.xx jahr xx monat xx tag
const double parser__KBASIC_VERSION 	= 1.080924; // versionsnr.xx jahr xx monat xx tag
...
const int parser__MAX_WITH	= 10;  // how many with may be inside other withs
