...
struct sub {
  ...
  int nModuleId;
	...
	int nParameterLStringLen[MAX_PARAM];
...
public:
  ...
  char  *getRealNameFromName(const char *acModule, const char *acName);
	...
	int addVar(int nModuleId, const char *acSub, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId = 0);
	...
	int  getLStringLenVar		(const char *acModule, const char *acSub, const char *acName);
	int  getLStringLenVar		(const char *acModule, const char *acSub, int nIdVar);
	...
	int addConst(int nModuleId, const char *acSub, const char *acName, int nScope, int nId = 0);
	...
	bool addParameter(int nId, const char *acName, const char *acType, int nParameterCall, bool bOptional, bool bDefault, bool bParamArray, t_array *a, defaultvalue *defval, int *nParamId, int *nParamLStringLen);
	bool firstParameter	(int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool nextParameter	(int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool lastParameter	(int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool prevParameter	(int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool getParameter	(int nId, const char *acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
