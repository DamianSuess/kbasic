...
public:
  ...
  // ***
	...
	memory_const *consts;
	//memory_const *myPropertyGetConsts;
	//memory_const *myPropertySetConsts;
};
...
public:
    ...
    const char *acFile,
    bool bIsAbstract = false, int nId = 0
    );
...
//	char   *getSuffixMethod		();
	...
	bool addParameterMethod(int nClassId, int nId, const char *acName, const char *acType, int nParameterCall, bool bOptional, bool bDefault, bool bParamArray, t_array *a, defaultvalue *defval, int *nParamId, int *nParamLStringLen);
	bool firstParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool nextParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool lastParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool prevParameterMethod	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool getParameterMethod	(int nClassId, int nId, const char *acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
  ...
  int	 getParameterCountMethod(int nClassId, int nId);
	...
	bool addParameterPropertySet(int nClassId, int nId, const char *acName, const char *acType, int nParameterCall, bool bOptional, bool bDefault, bool bParamArray, t_array *a, defaultvalue *defval, int *nParamId, int *nParamLStringLen);
	bool firstParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool nextParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool lastParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool prevParameterPropertySet	(int nClassId, int nId, const char **acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
	bool getParameterPropertySet	(int nClassId, int nId, const char *acName, const char **acType, int *nParameterCall, bool *bOptional, bool *bDefault, bool *bParamArray, t_array **a, defaultvalue **defval, int *nParamId, int *nParamLStringLen);
...
//	bool		nextPcodeCall	(int nClassId, pcode **pcodeCall, int *nPcodeOffset, int *nReturnPcodePos);
	...
	int addVar(int nClassId, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId = 0);
	...
	int getLStringLenVar		(int nClassId, int nId);
	int getLStringLenVar		(const char *acClassName, const char *acName);
	memory_variable *getVars	(int nClassId);
	memory_variable *getVars	(const char *acClassName);

	int addStaticVar(int nClassId, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId = 0);
	...
	int getLStringLenStaticVar		(int nClassId, int nId);
	int getLStringLenStaticVar		(const char *acClassName, const char *acName);
  ...
  // vars of static block of class
	int addStaticCodeVar(int nClassId, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen);
	...
	int getLStringLenStaticCodeVar		(int nClassId, int nId);
	int getLStringLenStaticCodeVar		(const char *acClassName, const char *acName);
	memory_variable *getStaticCodeVars	(int nClassId);
	memory_variable *getStaticCodeVars	(const char *acClassName);

	int addMethodVar(int nClassId, const char *acMethod, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId = 0);
	...
	int getLStringLenMethodVar		(int nClassId, const char *acMethod, int nVar);
	int getLStringLenMethodVar		(const char *acClassName, const char *acMethod, const char *acName);
	...
	int addPropertyGetVar(int nClassId, const char *acProperty, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId = 0);
	...
	int getLStringLenPropertyGetVar		(int nClassId, const char *acProperty, int nVar);
	int getLStringLenPropertyGetVar		(const char *acClassName, const char *acProperty, const char *acName);
	...
	int addPropertySetVar(int nClassId, const char *acProperty, const char *acName, int nType, t_array *a, bool bStatic, int nScope, int nLStringLen, int nId = 0);
	...
	int getLStringLenPropertySetVar		(int nClassId, const char *acProperty, int nVar);
	int getLStringLenPropertySetVar		(const char *acClassName, const char *acProperty, const char *acName);
	...
	int addConst(int nClassId, const char *acName, int nScope, int nId = 0);
	...
	int addMethodConst(int nClassId, const char *acMethod, const char *acName, int nId = 0);
...
protected:
  ...
  XIntMap list_class;
	XIntMap list_class2;
  class_* it[parser__MAX_ITERATOR];
