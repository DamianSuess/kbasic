...
void EVENT_CurrentItemChanged(t_integer Current, t_integer Previous){ 
  if (nEVENT_CurrentItemChanged != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer);  param->append(pcode__t_integer); 
  if ((nEVENT_CurrentItemChanged == 2) || (nEVENT_CurrentItemChanged == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "CurrentItemChanged", acGroup, acName, param))){
    nEVENT_CurrentItemChanged = 2;
		myInterpreter->pushStack(new interpreter_parameter(Current));
		myInterpreter->pushStack(new interpreter_parameter(Previous));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "CurrentItemChanged", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_CurrentItemChanged = 1;
}
	CLASS::EVENT_CurrentItemChanged(Current, Previous);
 }
void EVENT_ItemActivated(t_integer Id, t_integer Column){ 
  if (nEVENT_ItemActivated != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer);  param->append(pcode__t_integer); 
  if ((nEVENT_ItemActivated == 2) || (nEVENT_ItemActivated == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemActivated", acGroup, acName, param))){
    nEVENT_ItemActivated = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		myInterpreter->pushStack(new interpreter_parameter(Column));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemActivated", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemActivated = 1;
}
	CLASS::EVENT_ItemActivated(Id, Column);
 }
void EVENT_ItemChanged(t_integer Id, t_integer Column){ 
  if (nEVENT_ItemChanged != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer);  param->append(pcode__t_integer); 
  if ((nEVENT_ItemChanged == 2) || (nEVENT_ItemChanged == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemChanged", acGroup, acName, param))){
    nEVENT_ItemChanged = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		myInterpreter->pushStack(new interpreter_parameter(Column));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemChanged", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemChanged = 1;
}
	CLASS::EVENT_ItemChanged(Id, Column);
 }
void EVENT_ItemClicked(t_integer Id, t_integer Column){ 
  if (nEVENT_ItemClicked != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer);  param->append(pcode__t_integer); 
  if ((nEVENT_ItemClicked == 2) || (nEVENT_ItemClicked == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemClicked", acGroup, acName, param))){
    nEVENT_ItemClicked = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		myInterpreter->pushStack(new interpreter_parameter(Column));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemClicked", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemClicked = 1;
}
	CLASS::EVENT_ItemClicked(Id, Column);
 }
void EVENT_ItemCollapsed(t_integer Id){ 
  if (nEVENT_ItemCollapsed != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer); 
  if ((nEVENT_ItemCollapsed == 2) || (nEVENT_ItemCollapsed == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemCollapsed", acGroup, acName, param))){
    nEVENT_ItemCollapsed = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemCollapsed", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemCollapsed = 1;
}
	CLASS::EVENT_ItemCollapsed(Id);
 }
void EVENT_ItemDoubleClicked(t_integer Id, t_integer Column){ 
  if (nEVENT_ItemDoubleClicked != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer);  param->append(pcode__t_integer); 
  if ((nEVENT_ItemDoubleClicked == 2) || (nEVENT_ItemDoubleClicked == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemDoubleClicked", acGroup, acName, param))){
    nEVENT_ItemDoubleClicked = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		myInterpreter->pushStack(new interpreter_parameter(Column));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemDoubleClicked", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemDoubleClicked = 1;
}
	CLASS::EVENT_ItemDoubleClicked(Id, Column);
 }
void EVENT_ItemEntered(t_integer Id, t_integer Column){ 
  if (nEVENT_ItemEntered != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer);  param->append(pcode__t_integer); 
  if ((nEVENT_ItemEntered == 2) || (nEVENT_ItemEntered == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemEntered", acGroup, acName, param))){
    nEVENT_ItemEntered = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		myInterpreter->pushStack(new interpreter_parameter(Column));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemEntered", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemEntered = 1;
}
	CLASS::EVENT_ItemEntered(Id, Column);
 }
void EVENT_ItemExpanded(t_integer Id){ 
  if (nEVENT_ItemExpanded != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer); 
  if ((nEVENT_ItemExpanded == 2) || (nEVENT_ItemExpanded == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemExpanded", acGroup, acName, param))){
    nEVENT_ItemExpanded = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemExpanded", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemExpanded = 1;
}
	CLASS::EVENT_ItemExpanded(Id);
 }
void EVENT_ItemPressed(t_integer Id, t_integer Column){ 
  if (nEVENT_ItemPressed != 1){
	QList<int> *param = new QList<int>;
	 param->append(pcode__t_integer);  param->append(pcode__t_integer); 
  if ((nEVENT_ItemPressed == 2) || (nEVENT_ItemPressed == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemPressed", acGroup, acName, param))){
    nEVENT_ItemPressed = 2;
		myInterpreter->pushStack(new interpreter_parameter(Id));
		myInterpreter->pushStack(new interpreter_parameter(Column));
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemPressed", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemPressed = 1;
}
	CLASS::EVENT_ItemPressed(Id, Column);
 }
void EVENT_ItemSelectionChanged(){ 
  if (nEVENT_ItemSelectionChanged != 1){
	QList<int> *param = new QList<int>;
	
  if ((nEVENT_ItemSelectionChanged == 2) || (nEVENT_ItemSelectionChanged == 0 && myInterpreter && myInterpreter->hasEvent(kbScope, kbId, "ItemSelectionChanged", acGroup, acName, param))){
    nEVENT_ItemSelectionChanged = 2;
		EventSource = this; myInterpreter->callEvent(kbScope, kbId, "ItemSelectionChanged", acGroup, acName, param);
		delete param; return;
	}
	delete param;
  if (kbId) nEVENT_ItemSelectionChanged = 1;
}
	CLASS::EVENT_ItemSelectionChanged();
 }
...
int nEVENT_CurrentItemChanged;

int nEVENT_ItemActivated;

int nEVENT_ItemChanged;

int nEVENT_ItemClicked;

int nEVENT_ItemCollapsed;

int nEVENT_ItemDoubleClicked;

int nEVENT_ItemEntered;

int nEVENT_ItemExpanded;

int nEVENT_ItemPressed;

int nEVENT_ItemSelectionChanged;
...
{  
  ...
  nEVENT_CurrentItemChanged = 0;

  nEVENT_ItemActivated = 0;

  nEVENT_ItemChanged = 0;

  nEVENT_ItemClicked = 0;

  nEVENT_ItemCollapsed = 0;

  nEVENT_ItemDoubleClicked = 0;

  nEVENT_ItemEntered = 0;

  nEVENT_ItemExpanded = 0;

  nEVENT_ItemPressed = 0;

  nEVENT_ItemSelectionChanged = 0;
