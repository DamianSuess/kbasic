...
bool EVENT_OnContextMenu(t_integer X, t_integer Y, t_integer GlobalX, t_integer GlobalY){ 
  if (nEVENT_OnContextMenu != 1){
	static QList<int> param;
  if (kbId && nEVENT_OnContextMenu == 0){ 
    if (kbId && nEVENT_OnMouseWheel == 0){ 
